...
namespace KoenZomers.OneDrive.Api
{
    ...
    public class OneDriveGraphApi : OneDriveApi
    {
        ...
        /// </summary>
        protected override string AuthenticateUri => "https://login.microsoftonline.com/common/oauth2/v2.0/authorize?client_id={0}&response_type=code&redirect_uri={1}&response_mode=query&scope=offline_access+files.readwrite.all";
        ...
        public override string ConstructCompleteUrl(string commandUrl)
        {
