...
namespace KoenZomers.OneDrive.Api
{
    ...
    public abstract class OneDriveApi
    {
        ...
        public string GetAuthorizationTokenFromUrl(string url)
        {
            ...
            //var start = string.Concat(AuthenticationRedirectUrl, "?");
            //if (!url.StartsWith(start) && !url.StartsWith(string.Concat(AuthenticationRedirectUrl, "/?")))
            //{
            //    return null;
            //}
            ...
            if (match.Success)
            {
                AuthorizationToken = match.Groups[1].Value;
        ...
        public virtual string ConstructCompleteUrl(string commandUrl)
        {
